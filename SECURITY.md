...
starbox supports Go 1.19 and keeps the ecosystem interpreter baseline at
...
[GitHub security advisories](https://github.com/1set/starbox/security/advisories/new).
